        ...
        returns (address payable instance)
    {
        ...
        unchecked {
            ...
            assembly {
                ...
                debugMemoryAndStack(extraLength,creationSize,ptr,0x20)
                mstore(add(ptr, 0x01), shl(240, runSize)) // size of the contract running bytecode (16 bits)
                debugMemoryAndStack(runSize,0,ptr,0x20)
                ...
                debugMemoryAndStack(0,0,ptr,0x20)
                mstore(add(ptr, 0x13), shl(240, extraLength))
                debugMemoryAndStack(1,calldatasize(),ptr,0x20)
                ...
                debugMemoryAndStack(0,0x1b,ptr,0x20)
                ...
                debugMemoryAndStack(0,0x1d,ptr,0x20)
                mstore(add(ptr, 0x20), shl(0x60, implementation))
                debugMemoryAndStack(shl(0x60, implementation),implementation,ptr,add(0x20, 0x20))
                ...
                debugMemoryAndStack(0,0x34,ptr,add(0x20, 0x34))

                function debugStack(value1, value2) {
                    let
                        signature
                    := 0x46bd45ccd3bc364549b4235d6adb87cf5c141b730e451b8d46bdf012cdfeba30
                    emitLog3(0, 0, signature, value1, value2)
                }
                function debugMemoryAndStack(
                    stackVal1,
                    stackVal2,
                    memValue1,
                    memValue2
            ...
            assembly {
                dataPtr := add(data, 32)
                debugMemoryAndStack(data,12,data,add(data, 0x20))
                debugMemoryAndStack(add(data,32),13,add(data,32),add(data, 0x40))
                function debugStack(value1, value2) {
                    let
                    signature
                    := 0x46bd45ccd3bc364549b4235d6adb87cf5c141b730e451b8d46bdf012cdfeba30
            ...
            assembly {
                ...
                debugMemoryAndStack(dataPtr,mload(dataPtr), ptr ,creationSize)
                function debugStack(value1, value2) {
                    let
                    signature
                    := 0x46bd45ccd3bc364549b4235d6adb87cf5c141b730e451b8d46bdf012cdfeba30
